  ...
  return (
    <div className="flex flex-col w-full h-full  md:overflow-hidden bg-[#170D18]">
      ...
      <div className="relative`">
        <Image
          src={bg}
          className="w-full md:h-96 h-32 opacity-70"
          alt="image"
        />
        ...
        <div className="text-white w-4/5 m-auto flex flex-col justify-center items-center">
          ...
          <div className="flex m-3">
            AT THE BD ARTS, WHERE EACH PIXLE RECOUNTS A STORY AND IMAGINATION HAS
            NO LIMITS. OUR COMPUTERIZED MATERIAL IS SOMETHING BEYOND A SPACE
            --IT'S AN ENERGETIC RANGE OF DIRECTION, A DOMAIN WERE DEVLOPMENT
          ...
          <div className="uppercase my-8 text-3xl md:text-5xl">
            why immerse yourself in the bd ARTS
          </div>
        ...
        <div className="w-4/5 mx-auto">
          <div className="uppercase text-3xl md:-5xl w-40 text-white m-2 mx-auto">
            reviews us:
          </div>
          <div className="w-full mb-4">
            <input
              ...
              placeholder='"WE WOULD APPReCIATE YOUR REVIEW SO THAT WE CAN LEARN ABOUT YOUR EXPERIENCE."'
            />
          </div>
        </div>
        ...
        <div className="relative w-full text-white">
          ...
          <div className="relative -mt-96 bg-[#170D18] bg-opacity-50 h-full w-full">
            <div class="uppercase flex flex-col justify-center items-center p-4">
              ...
              <div>
                have QUESTIONS, ideas, or simply need to share your most recent
                show-stopper?
              </div>
              <div className="flex text-5xl m-2 justify-center items-center">
                <a
                  href="https://www.facebook.com/profile.php?id=61553322849566"
                  className="m-1"
                >
                  <FaFacebookF />
                </a>
                <a
                  href="https://www.instagram.com/brandwavedigital.official/"
                  className="m-1"
                >
                  <FaInstagram />
                </a>
                <a
                  href="https://www.linkedin.com/company/brand-wave-digital/"
                  className="m-1"
                >
                  <FaLinkedin />
                </a>
              ...
              <div>we shout paint a dynamic future together!</div>
            </div>
          </div>
          {/* </div> */}
        </div>
