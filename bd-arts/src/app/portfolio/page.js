...
const PortfolioCards = () => {
  ...
  <section class="py-10">
      ...
      <article class="rounded-xl p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
           <Link href="/portfolio">
    ...
    <div class="mx-auto grid max-w-6xl  grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      <article class="rounded-xl p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
          ...
          <div class="relative flex items-end overflow-hidden rounded-xl">
            <img src="https://images.unsplash.com/photo-1515955656352-a1fa3ffcd111?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="Hotel Photo" />
            <div class="flex items-center space-x-1.5 rounded-lg bg-blue-500 h-32 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
      ...
      <article class="rounded-xl    p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
          ...
          <div class="relative flex items-end overflow-hidden rounded-xl">
            ...
            <div class="absolute bottom-3 left-3 inline-flex items-center rounded-lg    p-2 shadow-md">
